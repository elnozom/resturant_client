          ...
          :  WillPopScope(
             onWillPop: () async => false,
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            if (isMobile) SizedBox(width: isMobile ? 20 : 30),
                ...
                drawer: isMobile
                    ? SizedBox(
                        ...
                        child: Drawer(
                          ...
                          child: controller.widgets.leftSideBar(context , controller.sideBarItems),
                        ),
                      )
                    : null,
                body: Container(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  child: Expanded(
                                    child: Obx(() => controller.itemsLoading.value
                                        ? LoadingWidget()
                                        : controller.widgets.itemsGrid(
                                            context,
                                            controller.items!,
                                            controller.addItem)),
                                  ),
                                ...
                                SizedBox(
                                    ...
                                    child: Container(
                                        child: Obx(() => controller
                                                .subGroupsLoading.value
                                            ? LoadingWidget()
                                            : controller.widgets.subGroupsList(
                                                context,
                ...
                bottomNavigationBar: controller.widgets.mainGroupsListAtBottom(
                    context, controller.mainGroups, controller.listSubGroups)),
          ),
    ));
  }
}