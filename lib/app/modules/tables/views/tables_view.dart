  ...
  Widget build(BuildContext context) {
    return Scaffold(
        floatingActionButton: Obx(() =>  FloatingActionButton(
                child: controller.notification.notificationWidget(context , controller.cartCount.value),
                onPressed: ()  {},
              ),
        ),
        appBar: AppBar(
        ...
        body: Container(
            ...
            child: Obx(() {
              return controller.loading.value
                  ? LoadingWidget()
                  : controller.widgets.tablesWidget(
                      controller.tables, controller.chooseTable, context);
            })));
  }
}
